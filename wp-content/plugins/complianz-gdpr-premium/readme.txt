...
* Improvement: Add beta release option
...
* Fix: TCF default banner text
* Fix: some PHP warnings in remote cookie scan
* Fix: catch item not being array in transient during license check
* Improvement: AddToAny integration updated, props @micropat
* Improvement: cleanup tar file on download of maxmind database
