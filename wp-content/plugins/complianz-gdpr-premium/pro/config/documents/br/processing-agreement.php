...
$this->pages['br']['processing']['document_elements'] = array(
	array(
	...
	array(
		'content' => '2. [name_of_processor-br]',
	),
	array(
	...
	array(
		...
		'content' =>
			'<ul>
                        <li>' . 'Insofar as the Contractor processes Personal Data on behalf of the Client within the scope of the Agreement, the Client qualifies as the Controller for the Processing of Personal Data and the Contractor as the Operator, pursuant to Article 5 of the General Law for the Protection of Personal Data (LGPD);' . '</li>
                        <li>' . 'The Parties to this Data Processing Agreement, within the meaning of Article 50 of the General Law for the Protection of Personal Data (LGPD), wish to record their agreements on the Processing of Personal Data.' . '</li>
                    </ul>',
	),
//	WHEREAS:
//Insofar as the Contractor processes Personal Data on behalf of the Client within the scope of the Agreement, the Client qualifies as the Controller for the Processing of Personal Data and the Contractor as the Operator, pursuant to Article 5 of the General Law for the Protection of Personal Data (LGPD);
//
//The Parties to this Data Processing Agreement, within the meaning of Article 50 of the General Law for the Protection of Personal Data (LGPD), wish to record their agreements on the Processing of Personal Data.
	...
	'article-5-3' => array(
		...
		'condition' => array(
			'security-protocol-where-br' => 1,
		)
	),
	'article-5-4' => array(
		'subtitle' => '',
		'content' => cmplz_sprintf(_x('The security protocol can be viewed online %shere%s.', 'Legal document processing agreement', 'complianz-gdpr'), '[security-protocol-where-url-br]', '[/security-protocol-where-url-br]'),
		'condition' => array(
			'security-protocol-where-br' => 2,
		)
	),
	'article-5-5' => array(
		'subtitle' => '',
	...
	'article-8-3' => array(
		...
		'condition' => array('deal_with_requests-br' => 2),
	),
	...
	'article-9-1a' => array(
		...
		'condition' => array('when-informed-br' => 1),
	),
	'article-9-1b' => array(
		'subtitle' => '',
		...
		'condition' => array('when-informed-br' => 2),
	),
	'article-9-1c' => array(
		'subtitle' => '',
		...
		'condition' => array('when-informed-br' => 3),
	),
	'article-9-2' => array(
		'subtitle' => '',
	...
	'article-11-3' => array(
		...
		'condition' => array('when-audit-br' => 1),
	),
	'article-11-4' => array(
		'subtitle' => '',
		...
		'condition' => array('when-audit-br' => 2),
	),
	'article-11-5' => array(
		'subtitle' => '',
		...
		'condition' => array('when-audit-br' => 3),
	),
	'article-11-6' => array(
		'subtitle' => '',
		...
		'condition' => array('when-audit-br' => 4),
	),
	'article-11-7' => array(
		'subtitle' => '',
		...
		'condition' => array('what-do-with-findings-br' => 1),
	),
	'article-11-8' => array(
		'subtitle' => '',
		...
		'condition' => array('what-do-with-findings-br' => 2),
	),
	'article-11-9' => array(
		'subtitle' => '',
		...
		'condition' => array('audit-costs-br' => 1),
	),
	'article-11-10' => array(
		'subtitle' => '',
		...
		'condition' => array('audit-costs-br' => 2),
	),
	'article-11-11' => array(
		'subtitle' => '',
		...
		'condition' => array('audit-costs-br' => 3),
	),
	...
	'article-12-2' => array(
		'subtitle' => '',
		'content' => cmplz_sprintf(_x('The liability of the Operator shall never exceed %s per year.', 'Legal document processing agreement', 'complianz-gdpr'), '[amount-liable-br]').
			'&nbsp;'._x('The limitation referred to in this Article shall not apply if and insofar as the damage is the result of intent or deliberate recklessness on the part of the Operator or its management.', 'Legal document processing agreement', 'complianz-gdpr'),
		'condition' => array('maximize-liability-br' => 'yes'),
	),

//    The liability of the Operator shall never exceed [line 144 input field] per year.
//The limitation referred to in this Article shall not apply if and insofar as the damage is the result of intent or deliberate recklessness on the part of the Operator or its management."
	'article-12-2b' => array(
		'subtitle' => '',
		'content' => cmplz_sprintf(_x('During the Data Processing Agreement, the Operator shall have and continue to have adequate insurance cover in place for liability in accordance with this article. The insurance policy should at least cover %s', 'Legal document processing agreement', 'complianz-gdpr'), '[max_cost_of_insurance-br]'),
	...
	'article-12-6' => array(
		...
		'condition' => array('access-to-policy-br' => 'yes')
	),
	'annex' => array(
		'annex' => true,
	...
	'annex-1' => array(
		...
		'content' => '[processor-activities-br]',
	),

	'annex-2' => array(
		'numbering' => false,
		'subtitle' => _x('Personal Data', 'Legal document processing agreement', 'complianz-gdpr'),
		'content' => cmplz_sprintf(_x('Within the scope of the Data Processing Agreement, the Operator shall process the following (special) personal data on the instructions of the Controller:', 'Legal document processing agreement', 'complianz-gdpr') . '<br />%s<br />%s', '[what-kind-of-data-br]', '[what-kind-of-data-other-br]'),
	),

	'annex-3' => array(
		'numbering' => false,
		'subtitle' => _x('Data subject categories', 'Legal document processing agreement', 'complianz-gdpr'),
		'content' => cmplz_sprintf(_x('Personal data of the following groups of persons shall be processed:', 'Legal document processing agreement', 'complianz-gdpr') . '<br />%s<br />%s', '[data-from-whom-br]', '[data-from-whom-other-br]'),
	),
	...
	'security-measures' => array(
		...
		'content' => _x('The purpose of this annex is to further specify the standards and measures the Operator must apply in connection with the security of the Processing. The following security measures have been taken:' , 'Legal document processing agreement', 'complianz-gdpr'),
			'[processing-security-measures-br]<br />[processing-security-measures-other-br]',
	...
	array(
		...
		'content' => _x('This agreement takes effect when all parties have signed it, and its date is the date next to [or below] the signature of the last signer to sign it.', 'Legal document processing agreement', 'complianz-gdpr') ."<br />
                      ...
                      <br />
                      <br />
                      ". _x('Operator', 'Legal document processing agreement', 'complianz-gdpr') .":<br />
                      <br />
