...
$this->pages['za']['privacy-statement-children']['document_elements'] = array(
	'last-updated' => array(
		'content' => '<i>' . cmplz_sprintf(_x('This privacy statement was last changed on %s, was last checked on %s and applies to citizens and legal permanent residents of South Africa.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]', '[checked_date]') . '</i><br /><br />',
	),

	'inleiding' => array(
		'p' => false,
		'content' =>
			'<p>'. cmplz_sprintf(_x('In this privacy statement, we explain what we do with the data we obtain about children via %s. We recommend you carefully read this statement. In our processing we comply with the requirements of South African privacy legislation. That means, among other things, that:', 'Legal document privacy statement', 'complianz-gdpr'), '[domain]') .'</p>'.
			'<ul>
	...
	array(
		...
		'content' => _x('We use the personal data from children for one or more of the following purposes:', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-what-purposes]',
	),
	array(
		'title' => _x('Registration', 'Legal document privacy statement', 'complianz-gdpr'),
		'content' => _x('Sometimes children need to register on our website in order to play games or to view content. For this purpose we use the following data:', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-what-information-registration]',
	...
	array(
		...
		'content' => _x('Sometimes children are creating content on our website, and sometimes personal information is inserted by the child in the created content. Where possible we try to delete that personal information or ask verifiable consent for the parents or guardians.', 'Legal document privacy statement', 'complianz-gdpr') .'<br /><br />'
		             . _x('We will also ask for consent when we plan to post content publicly. For this purpose we might use the following data:', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-what-information-content]',
	...
	array(
		...
		'content' => _x('There are games or activities that allow children to communicate with each other through a chatsystem or a messageboard. To protect children we employ filters , and recommend that parents supervise their children.', 'Legal document privacy statement', 'complianz-gdpr') .'<br /><br />'
		             . _x('For this purpose we use the following data:', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-what-information-chat]',
		'condition' => array('children-what-purposes' => 'chat')
	),

	array(
		'title' => _x('Email contact', 'Legal document privacy statement', 'complianz-gdpr'),
		'content' => _x('Sometimes it is necessary that we ask for an email address. We will do this in order to respond to a request or question from a child.', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-what-information-email]',
	...
	array(
		...
		'content' => _x('The Protection Of Personal Information Act requires that we search consent from a parent or guardian if we wish to collect personal data from a child. We use the following method(s):', 'Legal document privacy statement', 'complianz-gdpr')
		             .'&nbsp;[children-parent-consent-type]',
	),
		...
		'content' => '<p>Verifiable parental consent is not required in the case of:</p>'.
			'<ol class="alphabetic">
                        ...
                        <li>'. _x('online contact information collected from a child that is used only to respond more than once directly to a specific request from the child and is not used to recontact the child beyond the scope of that request', 'Legal document privacy statement', 'complianz-gdpr') .'
                            <ol>
                                <li>'. _x('if, before any additional response after the initial response to the child, the operator uses reasonable efforts to provide a parent notice of the online contact information collected from the child, the purposes for which it is to be used, and an opportunity for the parent to request that the operator make no further use of the information and that it not be maintained in retrievable form; or', 'Legal document privacy statement', 'complianz-gdpr') .'</li>
                                <li>'. _x('without notice to the parent in such circumstances as the Information Commissioner\'s Office may determine are appropriate, taking into consideration the benefits to the child of access to information and services, and risks to the security and privacy of the child;', 'Legal document privacy statement', 'complianz-gdpr') .'</li>
                            </ol>
                        </li>
	...
	array(
		'title' => _x('Disclosure practices', 'Legal document', 'complianz-gdpr'),
	...
	array(
		'subtitle' => _x('Operators', 'Legal document privacy statement', 'complianz-gdpr'),
	...
	array(
		...
		'content' =>
			'<p>
                ...
                <b>'._x('Country or state in which this operator is located:', 'Legal document privacy statement', 'complianz-gdpr').'</b>&nbsp;[country]<br />
            </p>',
		'condition' => array(
			'processor' => 'loop',
	...
	array(
		'subtitle' => _x('Third parties', 'Legal document privacy statement', 'complianz-gdpr'),
		'condition' => array(
			'share_data_other' => '1',
		),
	),
	...
	array(
		...
		'content' =>
			"<b>" ._x('Purpose of the data transfer:', 'Legal document privacy statement', 'complianz-gdpr') ."</b>&nbsp;[purpose]<br />
             <b>" ._x('Country or state in which this third party is located:' , 'Legal document privacy statement', 'complianz-gdpr') ."</b>&nbsp;[country]<br />",
		'condition' => array(
			'thirdparty' => 'loop',
			'share_data_other' => '1',
		),
	...
	array(
			'content' => _x('If our website or organisation is involved in a merger or acquisition, your details may be disclosed to our advisers and any prospective purchasers and will be passed on to the new owners.', 'Legal document privacy statement', 'complianz-gdpr'),
	),
	...
	array(
		'title' => _x('How we respond to Do Not Track signals & Global Privacy Control ', 'Legal document privacy statement', 'complianz-gdpr'),
