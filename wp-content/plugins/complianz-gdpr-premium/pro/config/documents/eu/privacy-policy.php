...
$this->pages['eu']['privacy-statement']['document_elements'] = array(
    'last-updated' => array(
        'content' => '<i>' . cmplz_sprintf(_x('This privacy statement was last updated on %s and applies to citizens and legal permanent residents of the European Economic Area and Switzerland.', 'Legal document privacy statement', 'complianz-gdpr'), '[publish_date]') . '</i><br /><br />',
    ),
    'inleiding' => array(
        'content' =>
            '<p>'. cmplz_sprintf(_x('In this privacy statement, we explain what we do with the data we obtain about you via %s. We recommend you carefully read this statement. In our processing we comply with the requirements of privacy legislation. That means, among other things, that:', 'Legal document privacy statement:paragraph title', 'complianz-gdpr'), '[domain]') .'</p>'.
            '<ul>
    ...
    'third-party-sharing' => array(
        ...
        'content' => _x( "We only share this data with processors and with other third parties for which consent must be obtained.", 'Legal document privacy statement', 'complianz-gdpr'),
    ...
    'no-sharing-limited' => array(
        'title' => _x('Sharing with other parties', 'Legal document privacy statement:paragraph title', 'complianz-gdpr'),
        'content' => _x('We only share or disclose this data to processors for the following purposes:', 'Legal document privacy statement', 'complianz-gdpr'),
        'condition' => array('share_data_other' => '3'),
    ),

    'no-sharing-limited-sub' => array(
        'numbering' => false,
        'subtitle' => _x('Processors', 'Legal document privacy statement', 'complianz-gdpr'),
        'condition' => array(
			'processor' => 'NOT EMPTY',
    ...
    'insight-changes-your-data' => array(
        'title' => _x('Accessing and modifying your data', 'Legal document privacy statement', 'complianz-gdpr'),
        'p'=>false,
        'content' =>
            ...
            '<ul>
                ...
                <li>' . _x('Right to transfer your data: you have the right to request all your personal data from the controller and transfer it in its entirety to another controller.', 'Legal document privacy statement', 'complianz-gdpr') . '</li>
    ...
    'automated_processes' => array(
        ...
        'content' => _x('We make decisions on the basis of automated processing with respect to matters that may have (significant) consequences for individuals. These are decisions taken by computer programs or systems without human intervention.', 'Legal document privacy statement', 'complianz-gdpr'),
    ...
    'complaints' => array(
        ...
        'content' => _x('If you are not satisfied with the way in which we handle (a complaint about) the processing of your personal data, you have the right to submit a complaint to the Data Protection Authority.', 'Legal document privacy statement', 'complianz-gdpr'),
    ),
    'data-protection-officer' => array(
        'title' => _x('Data Protection Officer', 'Legal document privacy statement:paragraph title', 'complianz-gdpr'),
        'content' => cmplz_sprintf(_x('Our Data Protection Officer has been registered with the data protection authority in an EU Member State. If you have any questions or requests with respect to this privacy statement or for the Data Protection Officer, you may contact %s, via %s or %s', 'Legal document privacy statement', 'complianz-gdpr'), '[name_dpo]', '[website_dpo]', '[email_dpo]'),
	...
	array(
		'title' => _x('Data requests', 'Legal document', 'complianz-gdpr'),
		'content' => _x("For the most frequently submitted requests, we also offer you the possibility to use our data request form",'Legal document', 'complianz-gdpr').'<br />[cmplz-data-request region="eu"]',
		'condition' => array(
			'datarequest' => 'yes',
		),
	),
    ...
    'gdpr_rep' => array(
        'content' => cmplz_sprintf(_x('We have appointed a representative within the EU. If you have any questions or requests with respect to this privacy statement or for our representative, you may contact %s, via %s, %s or by telephone on %s.', 'Legal document privacy statement', 'complianz-gdpr'), '[name_gdpr]', '[email_gdpr]', '[website_gdpr]', '[phone_gdpr]'),
    ...
    'custom_privacy_policy_text' => array(
        'title' => _x('Annex', 'Legal document privacy statement', 'complianz-gdpr'),
        'numbering' => false,
