...
$this->pages['us']['processing']['document_elements']= array(
    array(
    ...
    array(
        'content' => 'hereinafter referred to as: Service Provider',
    ),
    array(
    ...
    array(
        'subtitle' => '',
        'content' => 'This Data Processing Agreement shall terminate after and insofar as the Service Provider has deleted or returned all Personal Data in accordance with Article 9.',
    ),
    array(
        'subtitle' => '',
    ...
    array(
        'subtitle' => '',
        'content' => 'The Service Provider will endeavour to implement and maintain reasonable security procedures and practices appropriate to the nature of the information, to protect the Personal Information from unauthorized access, destruction, use, modification, or disclosure.',
        'condition' => array(
    ...
    array(
        'subtitle' => '',
        'content' => cmplz_sprintf('The security protocol can be viewed online %shere%s.', '[security-protocol-where-url-us]', '[/security-protocol-where-url-us]'),
        'condition' => array(
    ...
    array(
        'subtitle' => '',
        'content' => cmplz_sprintf('The Service Provider will endeavour to implement and maintain reasonable security procedures and practices appropriate to the nature of the information, to protect the Personal Information from unauthorized access, destruction, use, modification, or disclosure. To this end, the Service Provider shall take the technical and organizational security measures as set out in %s.', '[annex-security-measures-us]'),
        'condition' => array(
            'security_measures' => 3,
        )
    ),
    ...
    array(
     ...
     array(
        'subtitle' => '',
        'content' => 'Such an audit may be carried out once every three months, and more often in the event of a concrete suspicion of abuse. The Controller shall communicate the audit to the Service Provider in advance, with due observance of a minimum period of two weeks.',
        'condition' => array('when-audit-us' => 3),
    ),
    array(
        'subtitle' => '',
        'content' => 'Such an audit may be carried out once every calendar year, and more often in the event of a concrete suspicion of abuse. The Controller shall communicate the audit to the Service Provider in advance, with due observance of a minimum period of two weeks. ',
    ...
    array(
        'subtitle' => '',
        'content' => 'The Service Provider shall be liable towards the Controller for all consequences of the breach of this Data Processing Agreement, and shall indemnify the Controller against all claims by third parties, including any penalties, to the extent attributable to the Processor.',
    ),

    array(
        'subtitle' => '',
        'content' => cmplz_sprintf('The liability of the Service Provider shall never exceed %s per year. The limitation referred to in this Article shall not apply if and insofar as the damage is the result of intent or deliberate recklessness on the part of the Service Provider or its management.', '[amount-liable-us]'),
        'condition' => array('maximize-liability-us' => 'yes'),
    ),

    array(
        'subtitle' => '',
        'content' => cmplz_sprintf(_x('During the Data Processing Agreement, the Service Provider shall have and continue to have adequate insurance cover in place for liability in accordance with this article. The insurance policy should at least cover %s', 'Legal document processing agreement', 'complianz-gdpr'), '[max_cost_of_insurance-us]'),
    ...
    array(
        'numbering' => false,
        'title' => 'Certification as required by Section 1798.40 CCPA:',
    ...
    array(
        'numbering' => false,
        'subtitle' => 'Personal Data',
        'content' => cmplz_sprintf('Within the scope of the Data Processing Agreement, the Service Provider shall process the following Personal data on the instructions of the Controller:<br />%s<br />%s', '[what-kind-of-data-us]', '[what-kind-of-data-other-us]'),
    ),

    array(
        'numbering' => false,
        'subtitle' => 'Data subject categories',
        'content' => cmplz_sprintf('Personal data of the following groups of persons shall be processed:<br />%s<br />%s', '[data-from-whom-us]', '[data-from-whom-other-us]'),
    ),

    array(
        'numbering' => false,
        'subtitle' => 'Data subject categories',
        'content' => 'The Controller shall ensure that the purposes, personal data, and categories of data subjects described in this Annex 1 are complete and correct, and shall indemnify the Service Provider against any defects and claims resulting from an incorrect representation by the Controller.',
    ),
