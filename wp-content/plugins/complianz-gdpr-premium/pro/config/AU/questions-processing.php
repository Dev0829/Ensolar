...
$this->fields = $this->fields + array(
        'has-wizard-been-completed-processing-au' => array(
            'step' => 1,
            'section' => 1,
            'source' => 'processing-au',
            'type' => 'text',
            'default' => '',
        ...
        'data-from-whom-other-au' => array(
            ...
            'condition' => array('data-from-whom-au' => '11'),
        ),
        'what-kind-of-data-au' => array(
            'step' => 2,
            'section' => 1,
            'source' => 'processing-au',
            'type' => 'multicheckbox',
        ...
        'what-kind-of-data-other-au' => array(
            'step' => 2,
            'section' => 1,
            'source' => 'processing-au',
            'type' => 'text',
            ...
            'help' => __('Multiple categories should be separated with a semi-colon.' , 'complianz-gdpr'),
            'condition' => array('what-kind-of-data-au' => '13'),
        ),
        'allow-outside-au' => array(
            'step' => 2,
            'section' => 1,
            'source' => 'processing-au',
            'type' => 'radio',
            'default' => '',
            'required' => true,
            'label' => __("Do you allow data to be processed outside Australia?", 'complianz-gdpr'),
            'options' => array(
                '1' => __('No, processing outside Australia is not allowed.', 'complianz-gdpr'),
        ...
        'deal_with_requests-au' => array(
            ...
            'help' => __('An individual can make a subject access request to you verbally or in writing. It can also be made to any part of your organization (including by social media) and does not have to be to a specific person or contact point.','complianz-gdpr'),
        ),
        'security_measures-au' => array(
            'step' => 2,
            'section' => 2,
            'source' => 'processing-au',
            'type' => 'radio',
        ...
        'security-protocol-where-au' => array(
            'step' => 2,
            'section' => 2,
            'source' => 'processing-au',
            'type' => 'radio',
            ...
            'condition' => array('security_measures-au' => '2'),
        ),
        'security-protocol-where-url-au' => array(
            'step' => 2,
            'section' => 2,
            'source' => 'processing-au',
            'type' => 'url',
            ...
            'condition' => array('security-protocol-where-au' => '2'),
        ),
        'processing-security-measures-au' => array(
            'step' => 2,
            'section' => 2,
            'source' => 'processing-au',
            'type' => 'multicheckbox',
        ...
        'processing-security-measures-other-au' => array(
            'step' => 2,
            'section' => 2,
            'source' => 'processing-au',
            'type' => 'textarea',
            ...
            'condition' => array('processing-security-measures-au' => '17'),
        ),
        // RIGHT OF AUDIT
        'when-audit-au' => array(
            'step' => 2,
            ...
            'default' => '',
            'required' => true,
            'condition' => array('audit-au' => 'NOT 3'),
        ...
        'what-do-with-findings-au' => array(
            'step' => 2,
            'section' => 3,
            'source' => 'processing-au',
            'type' => 'radio',
        ...
        'when-informed-au' => array(
            ...
            'options' => array(
                '1' => __('Immediately (without unreasonable delay) after the security breach has become known to the Processor.', 'complianz-gdpr'),
                '2' => __('Immediately (without unreasonable delay), within 24 hours after the security breach has become known to the Processor.', 'complianz-gdpr'),
                '3' => __('Immediately (without unreasonable delay), within 36 hours after the security breach has become known to the Processor.', 'complianz-gdpr'),
            ),
        ),

        'maximize-liability-au' => array(
            'step' => 3,
            'source' => 'processing-au',
            'type' => 'radio',
            'default' => '',
            'options' => $this->yes_no,
            'label' => __("Do you want to limit the liability of the Processor?", 'complianz-gdpr'),
        ),

        'amount-liable-au' => array(
            'step' => 3,
            'source' => 'processing-au',
            'type' => 'text',
            'default' => '',
        ...
        'max_cost_of_insurance-au' => array(
            'step' => 3,
            'source' => 'processing-au',
            'type' => 'text',
            'default' => '',
            ...
            'condition' => array(
                'insurance-au' => 'yes',
                'maximize_cost_of_insurance-au'=>'yes'
            ),
        ),
        'insurance_conditions-au' => array(
            'step' => 3,
            'source' => 'processing-au',
            'type' => 'multicheckbox',
            'default' => '',
        ...
        'finish_setup_processing-au' => array(
            'step' => '4',
            'source' => 'processing-au',
