...
//			add_filter( 'cmplz_report_customer_columns', array( $this, 'report_customer_columns' ), 10 );
//			add_filter( 'cmplz_datarequest_data', array( $this, 'datarequest_data' ), 10 );
//			add_filter( 'cmplz_dnsmpd_column_has_data', array( $this, 'datarequest_column' ), 10, 2 );
