...
function cmplz_custom_add_new($post_type)
{
    // Region Select
...
function cmplz_admin_menu()
{
    ...
    foreach ($regions as $region => $label) {
        add_submenu_page(
            "admin.php?page=cmplz-processing-agreements",
        ...
        add_submenu_page(
            "admin.php?page=cmplz-dataleak-reports",
            cmplz_sprintf(__('Add new (%s)', 'complianz-gdpr'), $label),
            cmplz_sprintf(__('Add new (%s)', 'complianz-gdpr'), $label),
            apply_filters('cmplz_capability','manage_privacy'),
...
function cmplz_admin_parent_file($parent_file){
    ...
    if($current_screen->post_type == 'cmplz-processing') {
        $submenu_file = 'admin.php?page=cmplz-processing-agreements';
        $parent_file = 'complianz';
    }

    if($current_screen->post_type == 'cmplz-dataleak') {
        $submenu_file = 'admin.php?page=cmplz-dataleak-reports';
        $parent_file = 'complianz';
    }
 ...
 */
 function cmplz_add_dropdown_filter(){
    ...
    if (($page === 'cmplz-dataleak-reports' || $page ==='cmplz-processing-agreements' ) && cmplz_multiple_regions()) {
