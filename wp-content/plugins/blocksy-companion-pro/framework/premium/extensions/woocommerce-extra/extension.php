...
class BlocksyExtensionWoocommerceExtra {
	...
	public function __construct() {
		...
		add_filter('body_class', function ($classes) {
			if (blocksy_woo_has_floating_cart()) {
				$classes[] = 'has-floating-cart';
			}
		...
		add_filter('blocksy:frontend:dynamic-js-chunks', function ($chunks) {
			...
			$chunks[] = [
				...
				'selector' => '.ct-open-quick-view, [data-quick-view="image"] .type-product .ct-image-container, [data-quick-view="card"] > .type-product',
				'url' => blc_call_fn(
					[
						'fn' => 'blocksy_cdn_url',
