...
define('FLUENTFORMPRO_VERSION', '5.0.9');
...
//            'FluentFormPro\Integrations\Notion',
        ...
        public function boot()
        {
            ...
            if (!defined('FLUENTFORM_FRAMEWORK_UPGRADE')) {
                $message = '<div><h3>Fluent Forms Pro is not working. Update required.</h3><p>Fluent Forms Pro requires the latest version of the Fluent Forms Core Plugin. <a href="' . admin_url('plugins.php?s=fluentform&plugin_status=all') . '">' . __('Please update Fluent Forms to latest version', 'fluentformpro') . '</a>.</p></div>';
                $actions = [
