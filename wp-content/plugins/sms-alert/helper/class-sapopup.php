...
class SAPopup
{
                                                  ...
                                                  "elements" => [
                                                        [
                                                           ...
                                                           "settings" => [
                                                              ...
                                                              "sa_edit_mobile_number"=>    'Edit Number', "sa_edit_mobile_meaasege"=>    'Please enter mobile number to send OTP'
                                                           ], 
                                                           "elements" => [
                                                              ], 
    ...
    public static function getModelStyle($callback=null)
    {
        ...
        $content = '<div class="modal-body"><div style="margin:1.7em 1.5em;">'.$edit_phone_form.'<div style="position:relative" class="sa-message">'.esc_attr($sa_label).'</span></div>'.$number_label.'</div>		
        ...
        $content.= '<br><button type="button" name="smsalert_otp_validate_submit" style="color:grey; pointer-events:none;" id="sa_verify_otp" class="button smsalert_otp_validate_submit" value="Validate OTP">'.esc_attr($sa_button).'</button><br><a style="float:right" class="sa_resend_btn" onclick="saResendOTP(this)">'.esc_attr($sa_resend_btns).'</a><span class="sa_timer" style="min-width:80px; float:right"><span class="satimer">00:00:00</span> sec</span><span class="sa_forgot" style="float:right">'.esc_attr($sa_resend_otp).'</span><br></div></div>';    
        return $content;        
    }
