    ...
    protected function registerEditBtnStyleControls()
    {
        ...
        $this->add_control(
		 ...
		 $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .saeditphone' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .smsalertmodal-widget-wrapper .saeditphone',
            ]
        );
        $this->end_controls_section();
    }    
    ...
    protected function registerFormContainerStyleControls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic'],
                'selector' => '{{WRAPPER}} .smsalertmodal-widget-wrapper .modal-body',
                'exclude' => ['image'],        
            ]
        );   
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors'  => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .modal-body' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );      
        $this->end_controls_section();
    ...
    protected function registerLabelStyleControls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .sa-message, .smsalertmodal-widget-wrapper .sa-lwo-form label' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .sa-message, .smsalertmodal-widget-wrapper .sa-lwo-form label' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __('Typography', 'sms-alert'),
                'selector' => '{{WRAPPER}} .smsalertmodal-widget-wrapper .sa-message,.smsalertmodal-widget-wrapper .sa-lwo-form label',
            ]
        );
        $this->end_controls_section();
    }
    ...
    protected function registerSubmitButtonStyleControls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'width: {{SIZE}}{{UNIT}}', ],
                'condition' => [
                    'form_submit_button_width_type' => 'custom',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#409EFF',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn' => 'margin-top: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn:hover' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn:hover' => 'color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .smsalertmodal-widget-wrapper .smsalert_otp_validate_submit,.smsalertmodal-widget-wrapper #smsalert_share_cart,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_reg_with_otp_btn,.smsalertmodal-widget-wrapper .sa-lwo-form .smsalert_login_with_otp_btn:hover' => 'border-color: {{VALUE}}',
                ],
            ]
        );
