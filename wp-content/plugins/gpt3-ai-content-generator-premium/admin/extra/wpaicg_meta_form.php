...
<div class="wpaicg_grid_form" id="wpaicg-post-form">
    <div class="wpaicg_grid_form_2">
        <div class="mb-5">
            <input type="text" id="wpai_preview_title" placeholder="<?php echo esc_html__('Title: e.g. Mobile Phones','gpt3-ai-content-generator')?>" class="wpaicg-input" name="_wporg_preview_title" value="<?php echo  esc_html( $_wporg_preview_title ) ; ?>">
        </div>
        <div class="mb-5">
            <button type="button" name="get_preview" id="wpcgai_load_plugin_settings" class="button button-primary button-large"><?php echo esc_html__('Generate','gpt3-ai-content-generator')?></button>
        </div>
        <div class="mb-5">
            <div class="wpaicg-tabs">
                <ul>
                    <li id="wpaicg-seo-tab-content" data-target="wpaicg-tab-generated-text" class="wpaicg-active"><?php echo esc_html__('Content','gpt3-ai-content-generator')?></li>
                    <li id="wpaicg-seo-tab-item" data-target="wpaicg-seo-tab" class="<?php echo !empty($post->post_excerpt) ? 'wpaicg-has-seo' : ''?>"><?php echo esc_html__('SEO','gpt3-ai-content-generator')?></li>
                </ul>
                <div class="wpaicg-tab-content">
                    ...
                    <div id="wpaicg-seo-tab" style="display: none">
                        <p><?php echo esc_html__('Meta Description','gpt3-ai-content-generator')?></p>
        ...
        <div class="mb-5">
            <button type="button" style="display:none;" name="action_save_draft" id="wpcgai_save_draft_post_action" class="button button-large"><?php echo esc_html__('Save Draft','gpt3-ai-content-generator')?></button>
        </div>
    </div>
    <div class="wpaicg_grid_form_1">
        <div class="wpaicg-collapse wpaicg-collapse-active">
            <div class="wpaicg-collapse-title"><span>-</span> <?php echo esc_html__('Language, Style and Tone','gpt3-ai-content-generator')?></div>
        ...
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Headings','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_number_of_heading"><?php echo esc_html__('Headings','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_heading_tag"><?php echo esc_html__('Heading Tag','gpt3-ai-content-generator') ?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_modify_headings2"><?php echo esc_html__('Outline Editor','gpt3-ai-content-generator')?></label>
        ...
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Keywords','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="label_keywords"><?php
                        ...
                        ?></label>
                    <?php
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input type="text" id="wpai_keywords" placeholder="<?php echo esc_html__('e.g. battery life, cost, user friendliness','gpt3-ai-content-generator')?>" class="wpcgai_input" name="_wporg_keywords" value="">
                        <?php
                    } else{
                        ?>
                        <input type="text" class="wpcgai_input" disabled placeholder="<?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>">
                        <?php
                    }
                    ?>
                    <p class="wpaicg-help-text"><?php echo esc_html__('(Use comma to seperate keywords)','gpt3-ai-content-generator')?></p>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="label_words_to_avoid"><?php echo esc_html__('Keywords to Avoid?','gpt3-ai-content-generator')?></label>
                    <?php
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input type="text" id="wpai_words_to_avoid" placeholder="<?php echo esc_html__('e.g. top, best, click','gpt3-ai-content-generator')?>" class="wpcgai_input" name="_wporg_words_to_avoid" value="">
                        <?php
                    } else{
                        ?>
                        <input type="text" class="wpcgai_input" disabled placeholder="<?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>">
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="label_keywords_bold"><?php echo esc_html__('Make Keywords Bold?','gpt3-ai-content-generator')?></label>
                    <?php
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input<?php echo $_wporg_add_keywords_bold == 1 ? ' checked':''?> type="checkbox" id="wpai_add_keywords_bold2" name="_wporg_add_keywords_bold2" class="wpai-content-title-input" value="1"/>
                        <input type="hidden" id="wpai_add_keywords_bold" name="_wporg_add_keywords_bold" class="wpai-content-title-input" value="<?php echo esc_html($_wporg_add_keywords_bold)==1? "1" : "0";?>" />
                        <?php
                    } else{
                        ?>
                        <input type="checkbox" disabled id="wpai_add_keywords_bold" class="wpai-content-title-input" name="_wporg_add_keywords_bold" value="0"><?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>
                        <?php
                    }
                    ?>
                </div>
        ...
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Image','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <?php
                ...
                ?>
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Image','gpt3-ai-content-generator')?></label>
                    <select class="regular-text" id="wpaicg_image_source" name="wpaicg_image_source" >
                        ...
                        <option<?php echo $wpaicg_image_source == 'dalle' || ($wpaicg_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle"><?php echo esc_html__('DALL-E','gpt3-ai-content-generator')?></option>
                        <option<?php echo !empty($wpaicg_pexels_api) && $wpaicg_image_source == 'pexels' ? ' selected':'';?><?php echo empty($wpaicg_pexels_api) ? ' disabled':''?> value="pexels"><?php echo esc_html__('Pexels','gpt3-ai-content-generator')?></option>
                        <option<?php echo !empty($wpaicg_pixabay_api) && $wpaicg_image_source == 'pixabay' ? ' selected':'';?><?php echo empty($wpaicg_pixabay_api) ? ' disabled':''?> value="pixabay"><?php echo esc_html__('Pixabay','gpt3-ai-content-generator')?></option>
                    </select>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Featured Image','gpt3-ai-content-generator')?></label>
                    <select class="regular-text" id="wpaicg_featured_image_source" name="wpaicg_featured_image_source" >
                        <option value=""><?php echo esc_html__('None','gpt3-ai-content-generator')?></option>
                        <option<?php echo $wpaicg_featured_image_source == 'dalle' || ($wpaicg_featured_image_source == 'pexels' && empty($wpaicg_pexels_api)) ? ' selected' : ''?> value="dalle"><?php echo esc_html__('DALL-E','gpt3-ai-content-generator')?></option>
                        <option<?php echo !empty($wpaicg_pexels_api) && $wpaicg_featured_image_source == 'pexels' ? ' selected':'';?><?php echo empty($wpaicg_pexels_api) ? ' disabled':''?> value="pexels"><?php echo esc_html__('Pexels','gpt3-ai-content-generator')?></option>
                        <option<?php echo !empty($wpaicg_pixabay_api) && $wpaicg_featured_image_source == 'pixabay' ? ' selected':'';?><?php echo empty($wpaicg_pixabay_api) ? ' disabled':''?> value="pixabay"><?php echo esc_html__('Pixabay','gpt3-ai-content-generator')?></option>
                    </select>
                </div>
                <p><b><u><?php echo esc_html__('DALL-E','gpt3-ai-content-generator')?></u></b></p>
                <div class="mb-5 wpaicg-d-flex">
                    <?php
                    $_wporg_img_size = $result->img_size;
                    ?>
                    <label class="wpaicg-form-label" for="_wporg_img_size"><?php echo esc_html__('Image Size','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5 wpaicg-d-flex">
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="_wporg_img_style"><?php echo esc_html__('Image Style','gpt3-ai-content-generator')?></label>
                ...
                <div class="wpaicg_more_image_settings" style="display: none">
                    <div class="mb-5 wpaicg-d-flex">
                        <label for="artist" class="wpaicg-form-label"><?php echo esc_html__('Artist','gpt3-ai-content-generator')?>:</label>
                ...
                <p><u><b><?php echo esc_html__('Pexels','gpt3-ai-content-generator')?></b></u></p>
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Orientation','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Size','gpt3-ai-content-generator')?></label>
                ...
                <div class="wpaicg-mb-10">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Use Keyword [Beta]','gpt3-ai-content-generator')?>:</label>
                ...
                <div class="wpaicg-mb-10 wpaicg_pexels_custom_prompt" style="display:none">
                    ...
                    <textarea id="wpaicg_pexels_custom_prompt" rows="5" name="wpaicg_pexels_custom_prompt"><?php echo esc_html($wpaicg_pexels_custom_prompt)?></textarea>
                </div>
                <p><u><b><?php echo esc_html__('Pixabay','gpt3-ai-content-generator')?></b></u></p>
                <div class="wpaicg-mb-10">
                ...
                <div class="wpaicg-mb-10">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Image Type','gpt3-ai-content-generator')?>:</label>
                ...
                <div class="wpaicg-mb-10">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Order','gpt3-ai-content-generator')?>:</label>
                ...
                <div class="wpaicg-mb-10 wpaicg_pixabay_custom_prompt" style="display:none">
                    ...
                    <textarea id="wpaicg_pixabay_custom_prompt" rows="5" name="wpaicg_pixabay_custom_prompt"><?php echo esc_html($wpaicg_pixabay_custom_prompt)?></textarea>
                </div>
            </div>
        </div>
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Additional Content','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_add_tagline2"><?php echo esc_html__('Add Tagline?','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_add_intro2"><?php echo esc_html__('Add Introduction?','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_intro_title_tag"><?php echo esc_html__('Intro Title Tag','gpt3-ai-content-generator')?></label>
                    <select name="wpaicg_intro_title_tag" id="wpaicg_intro_title_tag">
                        <option value="h1" <?php echo esc_html($wpaicg_intro_title_tag) == 'h1' ? 'selected' : ''?>>h1</option>
                        <option value="h2" <?php echo esc_html($wpaicg_intro_title_tag) == 'h2' ? 'selected' : ''?>>h2</option>
                        <option value="h3" <?php echo esc_html($wpaicg_intro_title_tag) == 'h3' ? 'selected' : ''?>>h3</option>
                        <option value="h4" <?php echo esc_html($wpaicg_intro_title_tag) == 'h4' ? 'selected' : ''?>>h4</option>
                        <option value="h5" <?php echo esc_html($wpaicg_intro_title_tag) == 'h5' ? 'selected' : ''?>>h5</option>
                        <option value="h6" <?php echo esc_html($wpaicg_intro_title_tag) == 'h6' ? 'selected' : ''?>>h6</option>
                    </select>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Hide Introduction Title','gpt3-ai-content-generator')?></label>
                    <input type="checkbox" id="wpaicg_hide_introduction" name="wpaicg_hide_introduction" value="1"<?php echo  $wpaicg_hide_introduction ? " checked" : "" ; ?>/>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_add_conclusion2"><?php echo esc_html__('Add Conclusion?','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_conclusion_title_tag"><?php echo esc_html__('Conclusion Title Tag','gpt3-ai-content-generator');?></label>
                    <select name="wpaicg_conclusion_title_tag" id="wpaicg_conclusion_title_tag">
                        <option value="h1" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h1' ? 'selected' : ''?>>h1</option>
                        <option value="h2" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h2' ? 'selected' : ''?>>h2</option>
                        <option value="h3" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h3' ? 'selected' : ''?>>h3</option>
                        <option value="h4" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h4' ? 'selected' : ''?>>h4</option>
                        <option value="h5" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h5' ? 'selected' : ''?>>h5</option>
                        <option value="h6" <?php echo esc_html($wpaicg_conclusion_title_tag) == 'h6' ? 'selected' : ''?>>h6</option>
                    </select>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label"><?php echo esc_html__('Hide Conclusion Title','gpt3-ai-content-generator')?></label>
                    <input type="checkbox" id="wpaicg_hide_conclusion" name="wpaicg_hide_conclusion" value="1"<?php echo  $wpaicg_hide_conclusion ? " checked" : "" ; ?>/>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="label_faq"><?php echo esc_html__('Add Q&A?','gpt3-ai-content-generator')?></label>
                    <?php
                    if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                        ?>
                        <input<?php echo $_wporg_add_faq ? ' checked':''?> type="checkbox" id="wpai_add_faq2" name="_wporg_add_faq2" class="wpai-content-title-input" value="1"/>
                        <input type="hidden" id="wpai_add_faq" name="_wporg_add_faq" class="wpai-content-title-input" value="1" />
                        <?php
                    } else {
                        ?>
                        <input type="checkbox" value="0" disabled><?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>
                        <?php
                    }
                    ?>
                </div>
                <div class="mb-5">
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_toc"><?php echo esc_html__('Add Table of Contents?','gpt3-ai-content-generator')?></label>
                    <input<?php echo $wpaicg_toc ? ' checked': ''?> type="checkbox" value="1" name="wpaicg_toc" id="wpaicg_toc">
                </div>
                <div class="mb-5">
                    <?php
                    $wpaicg_toc_title = get_option('wpaicg_toc_title', esc_html__('Table of Contents','gpt3-ai-content-generator'));
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_toc_title"><?php echo esc_html__('ToC Title','gpt3-ai-content-generator')?></label>
                    <input type="text" class="regular-text" value="<?php echo esc_html($wpaicg_toc_title)?>" name="wpaicg_toc_title" id="wpaicg_toc_title">
                </div>
                <div class="mb-5">
                    <?php
                    ...
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_toc_title_tag"><?php echo esc_html__('ToC Title Tag','gpt3-ai-content-generator');?></label>
                    <select name="wpaicg_toc_title_tag" id="wpaicg_toc_title_tag">
                        <option value="h1" <?php echo esc_html($wpaicg_toc_title_tag) == 'h1' ? 'selected' : ''?>>h1</option>
                        <option value="h2" <?php echo esc_html($wpaicg_toc_title_tag) == 'h2' ? 'selected' : ''?>>h2</option>
                        <option value="h3" <?php echo esc_html($wpaicg_toc_title_tag) == 'h3' ? 'selected' : ''?>>h3</option>
                        <option value="h4" <?php echo esc_html($wpaicg_toc_title_tag) == 'h4' ? 'selected' : ''?>>h4</option>
                        <option value="h5" <?php echo esc_html($wpaicg_toc_title_tag) == 'h5' ? 'selected' : ''?>>h5</option>
                        <option value="h6" <?php echo esc_html($wpaicg_toc_title_tag) == 'h6' ? 'selected' : ''?>>h6</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Links','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_anchor_text"><?php echo esc_html__('Anchor Text?','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_target_url"><?php echo esc_html__('Target URL?','gpt3-ai-content-generator')?></label>
                ...
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_target_url_cta"><?php echo esc_html__('Add Call-to-Action?','gpt3-ai-content-generator')?></label>
                    ...
                    ?>">
                    <p class="wpaicg-help-text"><?php echo esc_html__('Enter target URL.','gpt3-ai-content-generator')?></p>
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpai_cta_pos"><?php echo esc_html__('CTA Position?','gpt3-ai-content-generator')?></label>
                    <select class="wpaicg-input" name="_wporg_cta_pos" id="wpai_cta_pos">
                        ...
                        ?>><?php echo esc_html__('Beginning','gpt3-ai-content-generator')?></option>
                        <option value="end" <?php
                        echo  ( esc_html( $_wporg_cta_pos ) == 'end' ? 'selected' : '' ) ;
                        ?>><?php echo esc_html__('End','gpt3-ai-content-generator')?></option>
                    </select>
                </div>
            </div>
        </div>
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('SEO','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <div class="mb-5">
                    <?php
                    $_wpaicg_seo_meta_desc = get_option('_wpaicg_seo_meta_desc',false);
                    ?>
                    <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo esc_html__('Meta Description','gpt3-ai-content-generator'); ?></label>
                    <input<?php echo  ( $_wpaicg_seo_meta_desc ? ' checked' : '' ) ; ?> type="checkbox" name="wpaicg_seo_meta_desc" id="wpaicg_seo_meta_desc" class="wpai-content-title-input" value="1" />
                </div>
                <div class="mb-5">
                    <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo esc_html__('Tags','gpt3-ai-content-generator'); ?></label>
                    <input style="width: 100%;" type="text" name="wpaicg_post_tags" id="wpaicg_post_tags" class="wpcgai_input" value="" />
                    <p class="wpaicg-help-text"><?php echo esc_html__('(Use comma to seperate tags)','gpt3-ai-content-generator')?></p>
                </div>
            </div>
        </div>
        <!--Custom Prompt-->
        <div class="wpaicg-collapse">
            <div class="wpaicg-collapse-title"><span>+</span><?php echo esc_html__('Custom Prompt','gpt3-ai-content-generator')?></div>
            <div class="wpaicg-collapse-content">
                <?php
                ...
                ?>
                <div class="mb-5">
                    <label><input<?php echo $wpaicg_content_custom_prompt_enable ? ' checked':''?> type="checkbox" class="wpaicg_meta_custom_prompt_enable" name="wpaicg_custom_prompt_enable">&nbsp;Enable</label>
                </div>
                <div class="wpaicg_meta_custom_prompt_box" style="<?php echo isset($wpaicg_content_custom_prompt_enable) && $wpaicg_content_custom_prompt_enable ? '':'display:none'?>">
                <h3><?php echo esc_html__('Best Practices and Tips','gpt3-ai-content-generator')?></h3>
                    ...
                    <label><?php echo esc_html__('Custom Prompt','gpt3-ai-content-generator')?></label>
                    <textarea rows="20" class="wpaicg_meta_custom_prompt" name="wpaicg_custom_prompt"><?php echo esc_html(str_replace("\\",'',$wpaicg_content_custom_prompt))?></textarea>
                    <?php
                    if(\WPAICG\wpaicg_util_core()->wpaicg_is_pro()):
                        ?>
                    ...
                    ?>
                    <button style="color: #fff;background: #df0707;border-color: #df0707;" data-prompt="<?php echo esc_html(\WPAICG\WPAICG_Custom_Prompt::get_instance()->wpaicg_default_custom_prompt)?>" class="button wpaicg_meta_custom_prompt_reset" type="button"><?php echo esc_html__('Reset','gpt3-ai-content-generator')?></button>
