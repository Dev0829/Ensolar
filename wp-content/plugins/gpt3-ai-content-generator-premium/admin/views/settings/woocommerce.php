        ...
        <div<?php echo $wpaicg_woo_custom_prompt ? '':' style="display:none"';?> class="wpaicg_woo_custom_prompts">
            ...
            <?php 
                echo sprintf(
                    ...
                    esc_html__('You can use the %1$s[current_short_description]%2$s shortcode to insert the current short description of your product into your prompt.','gpt3-ai-content-generator'),
                    '<code style="font-size: 0.95em;">',
                    '</code>'
                ); 
                ?>
            </div>
            ...
            <?php 
                echo sprintf(
                    /* translators: 1: opening code tag, 2: closing code tag */
                    esc_html__('You can use the %1$s[current_full_description]%2$s shortcode to insert the current full description of your product into your prompt.','gpt3-ai-content-generator'),
                    '<code style="font-size: 0.95em;">',
                    '</code>'
                ); 
                ?>
