...
<table width="100%" id="wpaicg-post-form">
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="text" id="wpai_keywords" placeholder="<?php echo esc_html__('e.g. battery life, cost, user friendliness','gpt3-ai-content-generator')?>" class="wpcgai_input" name="_wporg_keywords" value="<?php echo esc_html($_wporg_keywords); ?>">
                <?php
            } else{
                ?>
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="checkbox" id="wpai_add_keywords_bold2" name="_wporg_add_keywords_bold2" class="wpai-content-title-input"
                       value="<?php echo esc_html($_wporg_add_keywords_bold)==1? "1" : "0";?>" <?php echo esc_html($_wporg_add_keywords_bold)==1? "checked" : "";?> />
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="text" id="wpai_words_to_avoid" placeholder="<?php echo esc_html__('e.g. top, best, click','gpt3-ai-content-generator')?>" class="wpcgai_input" name="_wporg_words_to_avoid" value="<?php echo esc_html($_wporg_words_to_avoid); ?>">
                <?php
            } else{
                ?>
                <input type="text" class="wpcgai_input" disabled placeholder="<?php echo esc_html__('Available in Pro','gpt3-ai-content-generator')?>">
    ...
    <tr>
    <tr>
        <td><label style="font-weight: bold;" for="label_img"><?php echo  esc_html( __( "Image Source", "gpt3-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td><label style="font-weight: bold;" for="label_img"><?php echo  esc_html( __( "Featured Image Source", "gpt3-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td><b><u><?php echo esc_html__('DALL-E','gpt3-ai-content-generator')?></b></u></td>
    </tr>
    <tr>
    ...
    <tr>
    <td><b><u><?php echo esc_html__('Pexels','gpt3-ai-content-generator')?></b></u></td>
    </tr>
    <tr>
        <td>
            ...
            <select class="regular-text" id="wpaicg_pexels_orientation" name="wpaicg_pexels_orientation" >
                <option value=""><?php echo esc_html__('None','gpt3-ai-content-generator')?></option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'landscape' ? ' selected':''?> value="landscape"><?php echo esc_html__('Landscape','gpt3-ai-content-generator')?></option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'portrait' ? ' selected':''?> value="portrait"><?php echo esc_html__('Portrait','gpt3-ai-content-generator')?></option>
                <option<?php echo strtolower($wpaicg_pexels_orientation) == 'square' ? ' selected':''?> value="square"><?php echo esc_html__('Square','gpt3-ai-content-generator')?></option>
            </select>
        </td>
    </tr>
    <tr>
        <td>
            <div class="wpaicg-mb-10">
                ...
                <select class="regular-text" id="wpaicg_pexels_size" name="wpaicg_pexels_size" >
                    <option value=""><?php echo esc_html__('None','gpt3-ai-content-generator')?></option>
                    <option<?php echo strtolower($wpaicg_pexels_size) == 'large' ? ' selected':''?> value="large"><?php echo esc_html__('Large','gpt3-ai-content-generator')?></option>
                    <option<?php echo strtolower($wpaicg_pexels_size) == 'medium' ? ' selected':''?> value="medium"><?php echo esc_html__('Medium','gpt3-ai-content-generator')?></option>
                    <option<?php echo strtolower($wpaicg_pexels_size) == 'small' ? ' selected':''?> value="small"><?php echo esc_html__('Small','gpt3-ai-content-generator')?></option>
                </select>
            </div>
            <div class="wpaicg-mb-10">
    ...
    <tr>
        <td>
            <b><u><?php echo esc_html__('Pixabay','gpt3-ai-content-generator')?></b></u>
            <div class="wpaicg-mb-10">
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_intro_title_tag"><?php echo  esc_html( __( "Intro Title Tag", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <select name="wpaicg_intro_title_tag" id="wpaicg_intro_title_tag">
                <option value="h1" <?php echo  ( $wpaicg_intro_title_tag == 'h1' ? 'selected' : '' ) ; ?>>H1</option>
                <option value="h2" <?php echo  ( $wpaicg_intro_title_tag == 'h2' ? 'selected' : '' ) ; ?>>H2</option>
                <option value="h3" <?php echo  ( $wpaicg_intro_title_tag == 'h3' ? 'selected' : '' ) ; ?>>H3</option>
                <option value="h4" <?php echo  ( $wpaicg_intro_title_tag == 'h4' ? 'selected' : '' ) ; ?>>H4</option>
                <option value="h5" <?php echo  ( $wpaicg_intro_title_tag == 'h5' ? 'selected' : '' ) ; ?>>H5</option>
                <option value="h6" <?php echo  ( $wpaicg_intro_title_tag == 'h6' ? 'selected' : '' ) ; ?>>H6</option>
            </select>
        </td>
    </tr>
    <tr>
        <td><label class="wpaicg-form-label"><?php echo  esc_html( __( "Hide Introduction Title", "gpt3-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td><input id="wpaicg_hide_introduction" type="checkbox" name="wpaicg_hide_introduction" value="1"<?php echo  $wpaicg_hide_introduction ? " checked" : "" ; ?>/></td>
    </tr>
    ...
    <tr>
        <td>
            ...
            if (wpaicg_gacg_fs()->is_plan__premium_only('pro')) {
                ?>
                <input type="checkbox" id="wpai_add_faq2" name="_wporg_add_faq2" class="wpai-content-title-input"
                       value="<?php echo esc_html($_wporg_add_faq)==1? "1" : "0";?>" <?php echo esc_html($_wporg_add_faq)==1? "checked" : "";?> />
                <input type="hidden" id="wpai_add_faq" name="_wporg_add_faq" class="wpai-content-title-input" value="<?php echo esc_html($_wporg_add_faq)==1? "1" : "0";?>" />
                <?php
            } else {
                ?>
    ...
    <tr>
        ...
        <td>
            <label class="wpaicg-form-label" for="wpaicg_conclusion_title_tag"><?php echo  esc_html( __( "Conclusion Title Tag", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <select name="wpaicg_conclusion_title_tag" id="wpaicg_conclusion_title_tag">
                <option value="h1" <?php echo  ( $wpaicg_conclusion_title_tag == 'h1' ? 'selected' : '' ) ; ?>>H1</option>
                <option value="h2" <?php echo  ( $wpaicg_conclusion_title_tag == 'h2' ? 'selected' : '' ) ; ?>>H2</option>
                <option value="h3" <?php echo  ( $wpaicg_conclusion_title_tag == 'h3' ? 'selected' : '' ) ; ?>>H3</option>
                <option value="h4" <?php echo  ( $wpaicg_conclusion_title_tag == 'h4' ? 'selected' : '' ) ; ?>>H4</option>
                <option value="h5" <?php echo  ( $wpaicg_conclusion_title_tag == 'h5' ? 'selected' : '' ) ; ?>>H5</option>
                <option value="h6" <?php echo  ( $wpaicg_conclusion_title_tag == 'h6' ? 'selected' : '' ) ; ?>>H6</option>
            </select>
        </td>
    </tr>
    <tr>
        <td><label class="wpaicg-form-label"><?php echo  esc_html( __( "Hide Conclusion Title", "gpt3-ai-content-generator" ) ) ; ?></label></td>
    </tr>
    <tr>
        <td><input type="checkbox" id="wpaicg_hide_conclusion" name="wpaicg_hide_conclusion" value="1"<?php echo  $wpaicg_hide_conclusion ? " checked" : "" ; ?>/></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc"><?php echo  esc_html( __( "Table of Content?", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <input<?php echo  ( $wpaicg_toc ? ' checked' : '' ) ; ?> type="checkbox" name="wpaicg_toc" id="wpaicg_toc" value="1" />
        </td>
    </tr>
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc_title"><?php echo  esc_html( __( "ToC Title", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <input type="text" name="wpaicg_toc_title" id="wpaicg_toc_title" class="regular-text" value="<?php echo esc_html($wpaicg_toc_title)?>" />
        </td>
    </tr>
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_toc_title_tag"><?php echo  esc_html( __( "ToC Title Tag", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <select name="wpaicg_toc_title_tag" id="wpaicg_toc_title_tag">
                <option value="h1" <?php echo  ( $wpaicg_toc_title_tag == 'h1' ? 'selected' : '' ) ; ?>>H1</option>
                <option value="h2" <?php echo  ( $wpaicg_toc_title_tag == 'h2' ? 'selected' : '' ) ; ?>>H2</option>
                <option value="h3" <?php echo  ( $wpaicg_toc_title_tag == 'h3' ? 'selected' : '' ) ; ?>>H3</option>
                <option value="h4" <?php echo  ( $wpaicg_toc_title_tag == 'h4' ? 'selected' : '' ) ; ?>>H4</option>
                <option value="h5" <?php echo  ( $wpaicg_toc_title_tag == 'h5' ? 'selected' : '' ) ; ?>>H5</option>
                <option value="h6" <?php echo  ( $wpaicg_toc_title_tag == 'h6' ? 'selected' : '' ) ; ?>>H6</option>
            </select>
        </td>
    </tr>
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo  esc_html( __( "Meta Description", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <label class="wpaicg-form-label" for="wpaicg_seo_meta_desc"><?php echo  esc_html( __( "Tags", "gpt3-ai-content-generator" ) ) ; ?></label>
        </td>
    </tr>
    <tr>
        <td>
            <input style="width: 100%;" type="text" name="wpaicg_post_tags" id="wpaicg_post_tags" class="wpcgai_input" value="<?php echo esc_html($_wpaicg_post_tags)?>" />
    ...
    <tr>
        <td>
            <div class="mb-5">
                <label><input<?php echo isset($wpaicg_custom_prompt_enable) && $wpaicg_custom_prompt_enable ? ' checked':''?> type="checkbox" class="wpaicg_meta_custom_prompt_enable" name="wpaicg_custom_prompt_enable">&nbsp;Enable</label>
            </div>
            <div class="wpaicg_meta_custom_prompt_box" style="<?php echo isset($wpaicg_custom_prompt_enable) && $wpaicg_custom_prompt_enable ? '':'display:none'?>">
                <label><?php echo esc_html__('Custom Prompt','gpt3-ai-content-generator')?></label>
                <textarea rows="20" class="wpaicg_meta_custom_prompt" name="wpaicg_custom_prompt"><?php echo esc_html($wpaicg_custom_prompt)?></textarea>
                <?php
    ...
    <tr>
        <td>
            ...
            <div class="wpaicg-tabs">
                <ul>
                    <li id="wpaicg-seo-tab-content" data-target="wpaicg-tab-generated-text" class="wpaicg-active<?php echo !empty($_wporg_generated_text) ? ' wpaicg-has-seo' : ''?>"><?php echo esc_html__('Content','gpt3-ai-content-generator')?></li>
                    <li id="wpaicg-seo-tab-item" data-target="wpaicg-seo-tab" class="<?php echo !empty($wpaicg_post_excerpt) ? 'wpaicg-has-seo' : ''?>"><?php echo esc_html__('SEO','gpt3-ai-content-generator')?></li>
                </ul>
                <div class="wpaicg-tab-content">
                    <div id="wpaicg-tab-generated-text">
                        <textarea id="wpcgai_preview_box" name="_wporg_generated_text" rows="20" cols="20" class="wpai-content-generator-textarea"><?php echo  esc_html( $_wporg_generated_text ) ; ?></textarea>
                    </div>
                    <div id="wpaicg-seo-tab" style="display: none">
                        <p><?php echo esc_html__('Meta Description','gpt3-ai-content-generator')?></p>
                        <textarea id="wpaicg-meta-description" name="_wpaicg_meta_description" rows="20" cols="20"><?php echo esc_html($wpaicg_post_excerpt); ?></textarea>
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td>
            <div class="btn-group" style="display:flex; gap:20px;">
                <button type="submit" name="get_preview" id="wpcgai_load_plugin_settings" class="button button-primary button-large"><?php echo esc_html__('Generate','gpt3-ai-content-generator')?></button>
...
<script>
    ...
    jQuery("#wpcgai_add_new_heading").on("click", function(e)
    {
        if(jQuery('#myModal .wpcgai_menu_editor li').length >= 10){
            alert('<?php echo esc_html__('Limited 10 headings','gpt3-ai-content-generator')?>')
        }
        else{
