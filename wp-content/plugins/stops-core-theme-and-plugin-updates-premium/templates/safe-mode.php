...
<div class="eum-advanced-settings-container plugin-safe-mode">
	...
	<div class="mpsum-notice mpsum-regular"><?php esc_html_e('"Safe mode" will block automatic updates to plugin  and theme updates if the update states a minimum PHP or WP version requirement that is not met by this site/server. This can prevent your site crashing due to running incompatible plugins/themes.', 'stops-core-theme-and-plugin-updates'); ?></div>
	<div id="safe-mode">
	<?php
