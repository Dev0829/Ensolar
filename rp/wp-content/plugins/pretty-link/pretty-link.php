<?php
/*
Plugin Name: Pretty Links Developer Edition
...
define('PRLI_EDITION', 'pretty-link-pro-developer');

update_option('prli_activated', true);
update_option('prli_activation_override',true);
update_option('prlipro-credentials',array('username'=>'GPL','password'=>'GPL'));
update_option('prlipro_activated',true);
update_option('plp_mothership_license','GPL');
wp_cache_delete('alloptions', 'options');
if(!defined('PRETTYLINK_LICENSE_KEY'))
{
define('PRETTYLINK_LICENSE_KEY','GPL');
}
