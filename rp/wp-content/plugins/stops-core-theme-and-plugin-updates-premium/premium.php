...
if (!class_exists('MPSUM_Premium')) {
	...
	class MPSUM_Premium {
		...
		public function run_updater() {
			...
			try {
				new Updraft_Manager_Updater_1_8(EASY_UPDATES_MANAGER_SITE_URL . 'plugin-info/', 7, EASY_UPDATES_MANAGER_SLUG, array('require_login' => false));
			} catch (Exception $e) {
		...
		public function i18n($i18n) {
			...
			$premium_i18n = array(
				...
				'import_invalid_json_file' => __('Error: The chosen file is corrupt. Please choose a valid Easy Updates Manager export file.', 'stops-core-theme-and-plugin-updates'),
				'site_url' => get_option('siteurl'),
				'import_confirmation' => __("The file you're trying to import is not of this site, If you have customized plugin and themes update settings, this will override this site's settings. Do you still want to import settings?", 'stops-core-theme-and-plugin-updates'),
			);
