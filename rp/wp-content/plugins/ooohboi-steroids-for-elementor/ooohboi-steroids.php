 ...
 * Domain Path: /lang
 * License: GPLv3
 * Elementor tested up to: 3.10.9
 * Elementor Pro tested up to: 3.10.9
	...
	*/
	public function ooohboi_init_extensions( $ob_settings_options ) {
		...
		$extensions_array = [ 'OoohBoi_Harakiri' => 'ob_use_harakiri', 'OoohBoi_Overlay_Underlay' => 'ob_use_poopart', 'OoohBoi_Overlaiz' => 'ob_use_overlaiz', 'OoohBoi_Paginini' => 'ob_use_paginini', 'OoohBoi_Breaking_Bad' => 'ob_use_breakingbad', 
							  ...
							  'OoohBoi_Tabbr' => 'ob_use_tabbr', 'OoohBoi_Postman' => 'ob_use_postman', /*'OoohBoi_Interactor' => 'ob_use_interactor', */ 'OoohBoi_Typo' => 'ob_use_typo', 'OoohBoi_Better_Templates_Library' => 'ob_use_btl' ];
