	...
	class WP_Sheet_Editor_Factory {
		...
		function __construct( $args = array() ) {
			...
			$this->texts = array(
				...
				'export_scheduled_in_popup'           => __( '<p>The export has been scheduled. You can close this popup. <a data-remodal-target="vgse_scheduled_exports_modal">View scheduled exports</a>.</p>', 'vg_sheet_editor' ),
				'import_scheduled_in_popup'           => __( '<p>The import has been scheduled. You can close this popup. <a data-remodal-target="vgse_scheduled_imports_modal">View scheduled imports</a>.</p>', 'vg_sheet_editor' ),
				'save_rows_scheduled_in_popup'           => __( '<p>The changes have been scheduled. You can close this popup. <a data-remodal-target="vgse_scheduled_save_rows_modal">View scheduled changes</a>.</p>', 'vg_sheet_editor' ),
				'bulk_edit_scheduled_in_popup'           => __( '<p>The bulk edit has been scheduled. You can close this popup. <a data-remodal-target="vgse_scheduled_bulk_edits_modal">View scheduled bulk edits</a>.</p>', 'vg_sheet_editor' ),
				'export_name_input_required'          => __( 'Name of this export', 'vg_sheet_editor' ),
				'confirm_delete_scheduled_job'          => __( 'Are you sure you want to delete this scheduled job and all its related files?', 'vg_sheet_editor' ),
				...
				'confirm_delete_row'                  => __( 'We will delete the selected row(s) from the database completely. If you want to restore them later, you should make a backup before. Do you want to delete them?', 'vg_sheet_editor' ),
		...
		function get_editor_settings( $current_provider_in_page ) {
			...
			$all_spreadsheet_columns_settings = $this->_remove_column_objects( $all_spreadsheet_columns_settings );
			...
			$this->texts['hint_missing_column_on_scroll'] = ( defined( 'VGSE_ANY_PREMIUM_ADDON' ) && VGSE_ANY_PREMIUM_ADDON && VGSE()->helpers->user_can_manage_options() && is_admin() ) ? __( '<h3>Missing column?</h3><button class="button show-column-missing-tips"  data-remodal-target="modal-columns-visibility">Open columns manager</button> or <button class="button">Close this</button>', 'vg_sheet_editor' ) : '';
		...
		function disallow_file_uploads_for_some_users( $allowed, $key, $args ) {
			...
			if ( in_array( $args['type'], array( 'boton_gallery', 'boton_gallery_multiple' ) ) && ! WP_Sheet_Editor_Helpers::current_user_can( 'upload_files' ) ) {
				return false;
			}
			return $allowed;
		}
