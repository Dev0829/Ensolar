			...
			$this->sections['customize_features'] = array(
				...
				'fields' => array(
					...
					array(
						'id'      => 'be_rest_api_only',
						'type'    => 'switch',
						'title'   => __( 'Deactivate everything. Use the REST API only', 'vg_sheet_editor' ),
						'desc'    => __( 'If you activate this option we will deactivate all the spreadsheets, settings pages, and the entire plugin will become invisible to the user. Only the REST API will remain active. This is useful for advanced scenarios when you only use our REST API to keep websites synchronized with external spreadsheets or systems. When this option is active, our settings page will moved under the general settings menu because our sheet editor menu will be removed', 'vg_sheet_editor' ),
						'default' => false,
					),
					array(
					...
					array(
						...
						'type'    => 'switch',
						'title'   => __( 'Enable the REST API', 'vg_sheet_editor' ),
						'desc'    => __( 'The REST API can be used for interacting with our spreadsheet from external apps.', 'vg_sheet_editor' ),
						'default' => false,
					),
					array(
