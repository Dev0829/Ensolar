	...
	class WPSE_WC_Products_Universal_Sheet {
		...
		public function sort_columns_after_export( $out, $wp_query_args, $spreadsheet_columns, $clean_data ) {
			...
			$wc_repeatable_columns = array(
				'attributes' => array(
					__( 'Attribute %d name', 'woocommerce' ),
					__( 'Attribute %d value(s)', 'woocommerce' ),
					__( 'Attribute %d visible', 'woocommerce' ),
					__( 'Attribute %d global', 'woocommerce' ),
					__( 'Attribute %d default', 'woocommerce' ),
				),
				'downloads'  => array(
