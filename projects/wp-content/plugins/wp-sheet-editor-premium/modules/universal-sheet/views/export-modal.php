						...
						<div class="field-wrap">
							<label class="excel-compatibility-container"><?php _e( 'What app will you use to edit this file? (optional)', 'vg_sheet_editor' ); ?><br>
								<select name="add_excel_separator_flag">
									...
									<option value=""><?php _e( 'Microsoft Excel (Office 365)', 'vg_sheet_editor' ); ?></option>
									<option value="yes"><?php _e( 'Other versions of Microsoft Excel', 'vg_sheet_editor' ); ?></option>
									<option value=""><?php _e( 'Google Sheets', 'vg_sheet_editor' ); ?></option>
									<option value=""><?php _e( 'Other', 'vg_sheet_editor' ); ?></option>
								</select>
							</label>
						</div>
					<?php } ?>
