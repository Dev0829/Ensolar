		...
		function render_formulas_form( $current_post_type ) {
			...
			<div class="remodal remodal4 modal-formula remodal-draggable" data-remodal-id="modal-formula" data-remodal-options="closeOnOutsideClick: false, hashTracking: false">
				...
				<div class="modal-content">
					...
					?>
					" method="POST" class="vgse-modal-form be-formulas active" onsubmit="vgseAllowToClosePageWithoutWarning(true);" id="vgse-create-formula">
						...
						<ul class="unstyled-list">
							...
							<li class="multiple-column-selector">
								...
								<select name="columns[]" required data-placeholder="<?php _e( 'Select column...', 'vg_sheet_editor' ); ?>" class="select2" multiple>
									<?php
									echo implode(
										apply_filters(
											'vg_sheet_editor/formulas/available_columns_options',
					...
					array(
						...
						array(
							array(
								...
								'options'    => '<option value="">(none)</option>' . VGSE()->helpers->get_post_type_columns_options(
									$current_post,
									array(
										'conditions' => array(
											'supports_formulas' => true,
