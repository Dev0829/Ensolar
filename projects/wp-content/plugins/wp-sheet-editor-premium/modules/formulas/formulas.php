...
if ( ! class_exists( 'WP_Sheet_Editor_Formulas' ) ) {
	...
	class WP_Sheet_Editor_Formulas {
		...
		function can_execute_formula_as_sql( $formula, $column, $post_type, $spreadsheet_columns, $raw_form_data ) {
			...
			if ( in_array( $raw_form_data['action_name'], array( 'add_time', 'reduce_time', 'remove_duplicates', 'remove_duplicates_title_content', 'remove_everything_after', 'remove_everything_before' ), true ) ) {
				return false;
			}
