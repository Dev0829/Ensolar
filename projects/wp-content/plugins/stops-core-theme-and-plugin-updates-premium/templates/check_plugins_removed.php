...
<div class="eum-advanced-settings-container check-plugins">
	...
	<div class="mpsum-notice mpsum-regular">
		<p><?php esc_html_e('Check for plugins which have been removed from the WordPress Plugin Directory. The results are cached for some hours; to clear your cache check the \'Force check\' option below.', 'stops-core-theme-and-plugin-updates'); ?></p>
