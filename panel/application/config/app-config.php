...
*
*/
define('APP_BASE_URL', 'https://panel.ensolarusa.com/');
...
*/
define('APP_ENC_KEY', '944bdc76c91c606710b186ddebc0a1bd');
 ...
 */
define('APP_DB_USERNAME', 'u966590352_panel');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Jarabacoa0517$');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'u966590352_panel');
