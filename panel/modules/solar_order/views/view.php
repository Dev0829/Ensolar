                            ...
                            <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('cc_customer_profile_id', $options, ['id', 'full_name'], _l('Customer Profile'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('project_status', $options, ['value', 'name'], _l('project_status'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('dealer_group', $options, ['value', 'name'], _l('dealer_group'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('building_department', $options, ['value', 'name'], _l('building_department'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('installation_type', $options, ['value', 'name'], _l('installation_type'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        echo render_select('financing_bank', $options, ['value', 'name'], _l('financing_bank'), $value,['disabled'=>true]);
                                        ?>
                                    </div>
