            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="Filter by" data-original-title="" title="">
                                <ul class="dropdown-menu dropdown-menu-right width300">
                                    <li hidden>
                                        <a href="#" data-cview="total" onclick="dt_custom_view('total','.table-<?php echo C_MODULE; ?>','total'); return false;"><?php echo _l('total'); ?></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <?php if (has_permission(C_MODULE_PERMISSION, '', 'create'))
                                { ?>
                                    <span class="pull-right header-btn-new">
                                <a href="<?php echo admin_url(C_MODULE.'/create') ?>" class="btn btn-info pull-left display-block"><?php echo _l('add');?>
                        ...
                        render_datatable($table_c, C_MODULE);
                        ?>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(function(){
        ...
        initDataTable('.table-<?php echo C_MODULE;?>', window.location.href,[],[0,0],dtServerParams,['0','DESC']);
